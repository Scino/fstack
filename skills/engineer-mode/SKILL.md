---
name: engineer-mode
description: fstack engineering execution. 23 playbooks, 22 principles, verified work, no slop. Use for /engineer-mode, /poteto-mode, or any non-trivial engineering task.
